...
export default function PolicyPage() {
  return (
    <>
      ...
      <p>
        This policy covers the NoSkrap website and documentation. It does not
      ...
      <h2>Documentation and the library</h2>
      <p>
        This documentation site does not run NoSkrap visitor scoring,
        interaction telemetry, or challenge cookies. Those are features of the
        library that a separate application can choose to use. That
        application’s operator is responsible for describing its configuration
        and data handling.
      </p>
